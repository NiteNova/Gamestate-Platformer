...
class LevelOne(States):
    ...
    def startup(self):
        print('Level 1!')
        plats.append(platform(100, 700)) #1
        plats.append(platform(200, 600)) #2
        plats.append(platform(300, 500)) #3
        plats.append(platform(400, 400)) #4
        plats.append(platform(550, 300)) #5
        plats.append(platform(400, 200)) #6
        plats.append(platform(250, 200)) #7
        plats.append(platform(50, 150)) #7
    
        goals.append(goal(65, 120))
